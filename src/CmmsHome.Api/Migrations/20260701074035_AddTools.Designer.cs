...
namespace CmmsHome.Api.Migrations
{
    ...
    [Migration("20260701074035_AddTools")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.MaintenanceRule", b =>
                {
                    ...
                    b.Property<int>("DueWindowUnit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("DueWindowValue")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ReminderLeadUnit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("ReminderLeadValue")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30);
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.PartCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.Tool", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.ToolCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.ToolLoan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.Part", b =>
                {
                    ...
                    b.HasOne("CmmsHome.Api.Models.PartCategory", "PartCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.Tool", b =>
                {
                    ...
                    b.HasOne("CmmsHome.Api.Models.ToolCategory", "ToolCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("CmmsHome.Api.Models.ToolLoan", b =>
                {
                    b.HasOne("CmmsHome.Api.Models.Tool", "Tool")
                        .WithMany("Loans")
